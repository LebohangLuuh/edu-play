...
public class Planets_Sotho_Slider extends PagerAdapter {
    Context context;
    LayoutInflater layoutInflater;

    public int[] list_Images = {
            R.drawable.mercury_sotho,
            R.drawable.venus_sotho,
            R.drawable.earth_sotho,
            R.drawable.mars_sotho,
            R.drawable.jupiter_sotho,
            R.drawable.saturn_sotho,
            R.drawable.uranus_sotho,
            R.drawable.neptune_sotho,
            R.drawable.pluto_sotho,
            R.drawable.sun_sotho,
            R.drawable.moon_sotho,
    };
    ...
    public Planets_Sotho_Slider(Context context) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
       ...
       /* TextView heading_text = view.findViewById(R.id.Planets_slider_heading);
        TextView Desc_text = view.findViewById(R.id.Planets_slider_desc);*/
        linearLayout.setBackgroundColor(list_B_Color[position]);
        imageView.setImageResource(list_Images[position]);
        /*heading_text.setText(list_Letter[position]);
        Desc_text.setText(list_Letter_Desc[position]);*/
